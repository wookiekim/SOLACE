...
def aesthetic_score():
    from solace.aesthetic_scorer import AestheticScorer
...
def clip_score(device):
    from solace.clip_scorer import ClipScorer
...
def pickscore_score(device):
    from solace.pickscore_scorer import PickScoreScorer
...
def imagereward_score(device):
    from solace.imagereward_scorer import ImageRewardScorer
...
def qwenvl_score(device):
    from solace.qwenvl import QwenVLScorer
...
def ocr_score(device):
    from solace.ocr import OcrScorer
...
def video_ocr_score(device):
    from solace.ocr import OcrScorer_video_or_image
